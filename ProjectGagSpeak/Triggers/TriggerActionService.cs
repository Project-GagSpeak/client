...
//    private readonly CallbackHandler _visualListener;
...
//            };
//            return await SelfBondageService.GagUpdateRetTask(layerIdx, gagSlot, DataUpdateType.Applied, _distributer, _visualListener).ConfigureAwait(false);
//        }
...
//            };
//            return await SelfBondageService.GagUpdateRetTask(layerIdx, gagSlot, DataUpdateType.Locked, _distributer, _visualListener).ConfigureAwait(false);
//        }
...
//            return await SelfBondageService.GagUpdateRetTask(layerIdx, new ActiveGagSlot(), DataUpdateType.Removed, _distributer, _visualListener);
//        }
...
//                Enabler = enactor ?? MainHub.UID
//            };
//            return await SelfBondageService.RestrictionUpdateRetTask(layerIdx, itemSlot, DataUpdateType.Applied, _distributer, _visualListener).ConfigureAwait(false);
//        }
//        else if (act.NewState is NewState.Locked)
//        {
...
//                PadlockAssigner = enactor ?? MainHub.UID
//            };
//            return await SelfBondageService.RestrictionUpdateRetTask(layerIdx, itemSlot, DataUpdateType.Locked, _distributer, _visualListener).ConfigureAwait(false);
//        }
//        else if (act.NewState is NewState.Disabled)
//        {
...
//            return await SelfBondageService.RestrictionUpdateRetTask(layerIdx, new ActiveRestriction(), DataUpdateType.Removed, _distributer, _visualListener).ConfigureAwait(false);
//        }
...
//                Enabler = enactor ?? MainHub.UID
//            };
//            return await SelfBondageService.RestraintUpdateRetTask(setData, DataUpdateType.Applied, _distributer, _visualListener).ConfigureAwait(false);
//        }
//        else if (act.NewState is NewState.Locked)
//        {
...
//                PadlockAssigner = enactor ?? MainHub.UID
//            };
//            return await SelfBondageService.RestraintUpdateRetTask(setData, DataUpdateType.Locked, _distributer, _visualListener).ConfigureAwait(false);
//        }
//        else if (act.NewState is NewState.Disabled)
//        {
...
//            return await SelfBondageService.RestraintUpdateRetTask(new CharaActiveRestraint(), DataUpdateType.Removed, _distributer, _visualListener).ConfigureAwait(false);
//        }
