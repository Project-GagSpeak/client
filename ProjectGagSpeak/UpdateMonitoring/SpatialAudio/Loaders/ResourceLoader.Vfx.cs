...
public unsafe partial class ResourceLoader
{
    ...
    private IntPtr ActorVfxNewDetour(string path, IntPtr a2, IntPtr a3, float a4, char a5, ushort a6, char a7)
    {
        ...
        _logger.LogTrace($"New Actor: {path} {vfx:X8}", LoggerType.SpatialAudio);
        return vfx;
    }
    ...
    private IntPtr ActorVfxRemoveDetour(IntPtr vfx, char a2)
    {
        ...
        _logger.LogTrace($"Removed Actor: {vfx:X8}", LoggerType.SpatialAudio);
    ...
    private IntPtr VfxUseTriggerDetour(IntPtr vfx, uint triggerId)
    {
        ...
        _logger.LogTrace($"Trigger {triggerId} on {vfx:X8}, timeline: {timeline:X8}", LoggerType.SpatialAudio);
        return timeline;
    }
}
