...
/// <summary>
///     Handles the distribution of ClientData IPC changes to other Visible Kinksters.
/// </summary>
public sealed class KinksterSyncService : DisposableMediatorSubscriberBase
{
    private readonly MainHub _hub;
    private readonly GlamourListener _glamour;
    private readonly ModListener _mods;
    private readonly MoodleListener _moodles;
    ...
    public KinksterSyncService(ILogger<KinksterSyncService> logger, GagspeakMediator mediator,
        MainHub hub, ClientAchievements achievements,
