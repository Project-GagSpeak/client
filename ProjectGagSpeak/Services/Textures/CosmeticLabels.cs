...
{ 
    public static readonly Dictionary<CorePluginTexture, string> NecessaryImages = new()
    {
        ...
        { CorePluginTexture.Tier1, "RequiredImages\\Tier1Icon.png" },
        { CorePluginTexture.Tier2, "RequiredImages\\Tier2Icon.png" },
        { CorePluginTexture.Tier3, "RequiredImages\\Tier3Icon.png" },
        { CorePluginTexture.Tier4, "RequiredImages\\Tier4Icon.png" },
