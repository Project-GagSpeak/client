...
public class BlindfoldService
{
    ...
    public void DrawBlindfoldOverlay()
    {
        ...
        var blindfoldImage = _renderService.GetImageMetadataPath(ImageDataType.Blindfolds, _appliedItem.BlindfoldPath);
        ...
        foregroundList.AddImage(
            ...
            Vector2.Zero,
            Vector2.One,
            CkGui.Color(new Vector4(1.0f, 1.0f, 1.0f, _config.Config.BlindfoldMaxOpacity))
        );
    }
}
