...
public class GagMuffleService : DisposableMediatorSubscriberBase
{
    ...
    public GagMuffleService(
        ILogger<GagMuffleService> logger,
    ...
    {
        var masterList = _mainConfig.Config.LanguageDialect switch
        {
