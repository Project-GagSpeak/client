...
public class RestrictionsPanel : MediatorSubscriberBase
{
    ...
    public RestrictionsManager(ILogger<RestrictionsManager> logger,
    ...
    private const string MoodleManagerStatusComboLabel = "##RestrictionsManagerStatusSelector";
    private const string MoodleManagerPresetComboLabel = "##RestrictionsManagerPresetSelector";
    ...
    public void DrawRestrictionsManager(Vector2 cellPadding)
    {
        MoodlesHeader();
        ImGui.Separator();
