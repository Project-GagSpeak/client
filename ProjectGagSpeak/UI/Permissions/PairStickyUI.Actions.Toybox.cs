    ...
    private void DrawToyboxActions()
    {
                ...
                _permActions.DrawGenericComboButton(PairUID, "ExecutePatternForPairPermCombo", "Play", WindowMenuWidth,
                    ...
                    onButton: (onButtonPress) =>
                    {
                        try
                        {
                            ...
                            _ = _apiHubMain.UserPushPairDataToyboxUpdate(new(StickyPair.UserData, newToyboxData, ToyboxUpdateType.PatternExecuted));
        ...
        if (_uiShared.IconTextButton(FontAwesomeIcon.StopCircle, "Stop " + PairNickOrAliasOrUID + "'s Active Pattern", WindowMenuWidth, true, patternStopDisabled))
        {
            try
            {
                ...
                _ = _apiHubMain.UserPushPairDataToyboxUpdate(new(StickyPair.UserData, newToyboxData, ToyboxUpdateType.PatternStopped));
                ...
                _permActions.DrawGenericComboButton(PairUID, "ExecutePatternForPairPermCombo", (isEnabled ? "Disable" : "Enable"), WindowMenuWidth, 
                    ...
                    onButton: (onButtonPress) =>
                    {
                        try
                        {
                            ...
                            _ = _apiHubMain.UserPushPairDataToyboxUpdate(new(StickyPair.UserData, newToyboxData, ToyboxUpdateType.AlarmToggled));
                   ...
                   onButton: (onButtonPress) =>
                    {
                        try
                        {
                            ...
                            _ = _apiHubMain.UserPushPairDataToyboxUpdate(new(StickyPair.UserData, newToyboxData, ToyboxUpdateType.TriggerToggled));
