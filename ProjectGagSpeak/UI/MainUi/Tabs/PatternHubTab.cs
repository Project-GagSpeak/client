...
public class PatternHubTab : DisposableMediatorSubscriberBase
{
    ...
    public PatternHubTab(ILogger<PatternHubTab> logger,
        GagspeakMediator mediator, PatternManager patterns,
    ...
    private void DrawPatternResultBox(ServerPatternInfo patternInfo)
    {
        ...
        using (ImRaii.Child($"##PatternResult_{patternInfo.Identifier}", new Vector2(ImGui.GetContentRegionAvail().X, height), true, ImGuiWindowFlags.ChildWindow))
        {
            ...
            using (ImRaii.Group())
            {
                ...
                UiSharedService.ColorText(patternInfo.Label, ImGuiColors.DalamudWhite);
    ...
    public void DrawSearchFilter()
    {
        ...
        var updateSize = _uiShared.GetIconButtonSize(FontAwesomeIcon.Search).X;
