...
public partial class PairStickyUI
{
    private void DrawToyboxActions()
    {
        ...
        {
            _ = _hub.UserUpdateOtherGlobalPerm(new(StickyPair.UserData, MainHub.PlayerUserData, new KeyValuePair<string, object>("ToyIsActive", !StickyPair.PairGlobals.ToyIsActive), UpdateDir.Other));
        ...
        if (_uiShared.IconTextButton(FontAwesomeIcon.StopCircle, stopPatternText, WindowMenuWidth, true, patternStopDisabled))
        {
            ...
            _ = _hub.UserPushPairDataToyboxUpdate(new(StickyPair.UserData, MainHub.PlayerUserData, newToyboxData, ToyboxUpdateType.PatternStopped, UpdateDir.Other));
