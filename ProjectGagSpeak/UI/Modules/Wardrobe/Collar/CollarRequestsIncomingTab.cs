...
public class CollarRequestsIncomingTab : IFancyTab
{
    ...
    public CollarRequestsIncomingTab(CollarManager manager, ClientData requests, TutorialService guides)
    {
        _manager = manager;
        _requests = requests;
        _guides = guides;
    ...
    public bool     Disabled    => _requests.ReqCollarIncoming.Count is 0;
