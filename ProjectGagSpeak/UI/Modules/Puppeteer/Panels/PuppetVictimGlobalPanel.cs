...
//        if (CosmeticService.CoreTextures.Cache[CoreTexture.PuppetAliases] is { } wrap)
//        {
...
//        CkGui.FramedIconText(FAI.Eye, !string.IsNullOrEmpty(globalPhrases) ? CkCol.IconOn.Uint() : uint.MaxValue);
//        CkGui.AttachToolTip(tooltip, color: ImGuiColors.DalamudRed);
//        ImUtf8.SameLineInner();
//        using (CkRaii.Child("ListenerName", new Vector2(ImGui.GetContentRegionAvail().X, ImGui.GetFrameHeight()), CkCol.CHeaderShadow.Uint(), DFlags.RoundCornersAll))
...
//    {
//        using var _ = CkRaii.FramedChildPaddedW("Triggers", paddedWidth, height, CkCol.CHeaderShadow.Uint(), CkCol.CHeaderShadow.Uint(), DFlags.RoundCornersAll);
