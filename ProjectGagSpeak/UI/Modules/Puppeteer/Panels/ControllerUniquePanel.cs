...
//        using var col = ImRaii.PushColor(ImGuiCol.FrameBg, CkCol.CHeaderShadow.Uint());
...
//        CkGui.SeparatorSpaced(CkCol.CHeaderShadow.Uint(), spacing.Y, c.InnerRegion.X);
...
//            {
//                using var col = ImRaii.PushColor(ImGuiCol.Button, CkCol.CHeaderShadow.Uint());
...
//                    wdl.AddRectFilled(ImGui.GetItemRectMin(), ImGui.GetItemRectMax(), CkCol.CHeaderShadow.Uint(), ImGui.GetStyle().FrameRounding, ImDrawFlags.RoundCornersAll);
//                    wdl.ChannelsMerge();
//                }
//            }
//        }
...
//        CkGui.FramedIconText(FAI.Eye, !playerStrRef.IsNullOrEmpty() ? CkCol.IconOn.Uint() : uint.MaxValue);
//        CkGui.AttachToolTip(tooltip);
//        ImUtf8.SameLineInner();
//        var listenerWidth = ImGui.GetContentRegionAvail().X - bracketsWidth;
//        using (CkRaii.Child("ListenerName", new Vector2(listenerWidth, ImGui.GetFrameHeight()), CkCol.CHeaderShadow.Uint(), dFlags: DFlags.RoundCornersAll))
...
//    {
//        using var _ = CkRaii.FramedChildPaddedW("Triggers", paddedWidth, height, CkCol.CHeaderShadow.Uint(), CkCol.CHeaderShadow.Uint(), ImDrawFlags.RoundCornersAll);
