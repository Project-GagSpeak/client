...
public class PuppeteerUI : WindowMediatorSubscriberBase
{
        ...
        TutorialService guides) : base(logger, mediator, "Puppeteer UI")
    {
        ...
        _tabMenu.AddDrawButton(_cosmetics.CoreTextures[CoreTexture.PuppetVictimGlobal], SelectedTab.VictimGlobal,
            "Configure how others can control you like a puppet, Globally!");
        _tabMenu.AddDrawButton(_cosmetics.CoreTextures[CoreTexture.PuppetVictimUnique], SelectedTab.VictimUnique,
            "Configure how others can control you, with unique configurations for every kinkster!");
        _tabMenu.AddDrawButton(_cosmetics.CoreTextures[CoreTexture.PuppetMaster], SelectedTab.ControllerUnique,
