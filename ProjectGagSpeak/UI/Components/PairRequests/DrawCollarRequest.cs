...
public class DrawCollarRequest
{
    private readonly MainHub _hub;
    private readonly string _id;

    private CollarOwnershipRequest _entry;
    private bool _hovered = false;
    public DrawCollarRequest(string id, CollarOwnershipRequest entry, MainHub hub)
    {
        _id = id;
        _entry = entry;
        _hub = hub;
    ...
    private void DrawLeftSide()
    {
        ...
        if (_entry.Writing.Length > 0) displayText += $" --SEP----COL--Collar Writing: --COL--{_entry.Writing}"; 
