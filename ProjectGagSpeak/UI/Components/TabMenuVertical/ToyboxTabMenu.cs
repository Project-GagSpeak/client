...
public class ToyboxTabMenu : TabMenuBase<ToyboxTabs.Tabs>
{
    ...
    protected override bool IsTabDisabled(ToyboxTabs.Tabs tab)
    {
        #if DEBUG
            return false;
        #else
            return tab == ToyboxTabs.Tabs.VibeServer;
        #endif
    }
    ...
    protected override string GetTabTooltip(ToyboxTabs.Tabs tab)
    {
        return tab switch
        {
            ...
            ToyboxTabs.Tabs.VibeServer => "Create, invite, or join other Vibe rooms, control other pairs sex toys live.--SEP--Under Construction during Open Beta",
