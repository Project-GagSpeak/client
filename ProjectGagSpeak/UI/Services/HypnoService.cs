...
public class HypnoService
{
    ...
    private HypnoticEffect? _effect => _appliedItem?.Effect;
    ...
    public void ApplyHypnosisEffect(HypnoticRestriction hypnoRestriction, UserData enactor)
    {
        ...
        _textDisplayTimer.Interval = hypnoRestriction.Effect.TextCycleSpeed;
    ...
    public void DrawHypnoEffect()
    {
        ...
        if (_renderService.GetImageMetadataPath(ImageDataType.Hypnosis, _appliedItem.HypnotizePath) is not { } hypnoImage)
            return;
