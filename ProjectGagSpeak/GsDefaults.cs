...
public static class GsDefaults
{
    ...
    public static NativeUiColor GlobalChatColor = new(Foreground: 0xFFFEE78F, Glow: 0xFF010101);

    // Nameplates
    public static NativeUiColor NameplateColorKinkster = new(Foreground: 0xFFBD97FF, Glow: 0xFFAE1AB5);
