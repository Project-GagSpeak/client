...
public sealed class GlobalPermissions : DisposableMediatorSubscriberBase
{
    ...
    {
        Mediator.Subscribe<DalamudLogoutMessage>(this, _ => _currentGlobals = null);
    }

    public GlobalPerms? Current 
        => _currentGlobals;

    public EmoteState ForcedEmoteState 
        => EmoteState.FromString(_currentGlobals?.ForcedEmoteState ?? string.Empty);
