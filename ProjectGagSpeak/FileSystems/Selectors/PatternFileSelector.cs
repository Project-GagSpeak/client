...
public sealed class PatternFileSelector : CkFileSystemSelector<Pattern, PatternFileSelector.PatternState>, IMediatorSubscriber, IDisposable
{
    ...
    protected override void DrawLeafName(CkFileSystem<Pattern>.Leaf leaf, in PatternState state, bool selected)
    {
    ...
    private void DrawLeafInternal(CkFileSystem<Pattern>.Leaf leaf, in PatternState state, bool selected)
    {
