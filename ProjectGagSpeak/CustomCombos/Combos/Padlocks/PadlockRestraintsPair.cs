...
public class PadlockRestraintsPair : CkPadlockComboBase<CharaWardrobeData>
{
    ...
    protected override void OnLockButtonPress()
    {
        ...
        _ = _mainHub.UserPushPairDataWardrobeUpdate(new(_pairRef.UserData, MainHub.PlayerUserData, newWardrobeData, ActiveSetUpdateType.RestraintLocked, string.Empty, UpdateDir.Other));
    ...
    protected override void OnUnlockButtonPress()
    {
        ...
        _ = _mainHub.UserPushPairDataWardrobeUpdate(new(_pairRef.UserData, MainHub.PlayerUserData, newWardrobeData, ActiveSetUpdateType.RestraintUnlocked, prevLock.ToName(), UpdateDir.Other));
