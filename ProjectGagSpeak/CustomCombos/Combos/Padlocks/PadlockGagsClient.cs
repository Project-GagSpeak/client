...
public class PadlockGagsClient : CkPadlockComboBase<GagSlot>
{
    private readonly GlobalData _gagData;
    private readonly AppearanceManager _appearance;
    public int GagSlotLayer { get; init; }

    public PadlockGagsClient(int layer, GlobalData gagData, AppearanceManager appearance, ILogger log, 
