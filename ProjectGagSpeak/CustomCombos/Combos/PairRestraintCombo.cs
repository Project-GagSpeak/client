...
public sealed class PairRestraintCombo : FilterComboButton<LightRestraintData>
{
    ...
    protected override void OnButtonPress()
    {
        ...
        // push to server.
        _ = _mainHub.UserPushPairDataWardrobeUpdate(new(_pairRef.UserData, MainHub.PlayerUserData, newWardrobe, ActiveSetUpdateType.RestraintApplied, newWardrobe.Padlock, UpdateDir.Other));
