...
internal static class GsLang
{
    ...
    public static readonly string[] GoToMyApartment = ["Go to your apartment", "移动到自己的房间", "移動到自己的房間", "自分の部屋に移動する", "자신의 방으로 이동", "Aller dans votre appartement", "Die eigene Wohnung betreten" ]; 
