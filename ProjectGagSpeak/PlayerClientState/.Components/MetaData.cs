...
public struct MetaDataStruct
{
    ...
    public void SetMeta(MetaIndex index, OptionalBool newValue)
    {
        switch (index)
        {
            case MetaIndex.HatState:    Headgear = newValue; break;
            case MetaIndex.VisorState:  Visor    = newValue; break;
            case MetaIndex.WeaponState: Weapon   = newValue; break;
        }
    }
