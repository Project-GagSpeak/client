...
public sealed partial class PairManager : DisposableMediatorSubscriberBase
{
    ...
    public void ReceiveCharaCompositeData(OnlineUserCompositeDataDto dto, string clientUID)
    {
        ...
        _allClientPairs[dto.User].ApplyLightStorageData(new(dto.User, dto.User, dto.CompositeData.LightStorageData));
        _allClientPairs[dto.User].ApplyAppearanceData(new(dto.User, dto.User, dto.CompositeData.AppearanceData, GagLayer.UnderLayer, GagUpdateType.FullDataUpdate, Padlocks.None));
        _allClientPairs[dto.User].ApplyWardrobeData(new(dto.User, dto.User, dto.CompositeData.WardrobeData, WardrobeUpdateType.FullDataUpdate, Padlocks.None));
        _allClientPairs[dto.User].ApplyToyboxData(new(dto.User, dto.User, dto.CompositeData.ToyboxData, ToyboxUpdateType.FullDataUpdate));
        ...
        if (dto.CompositeData.AliasData.ContainsKey(clientUID))
        {
            ...
            _allClientPairs[dto.User].ApplyAliasData(new(dto.User, dto.User, dto.CompositeData.AliasData[clientUID], PuppeteerUpdateType.FullDataUpdate));
        }
        else
        {
            Logger.LogTrace("No Alias Data Storage found for " + pair.GetNickAliasOrUid(), LoggerType.PairDataTransfer);
            _allClientPairs[dto.User].ApplyAliasData(new(dto.User, dto.User, new CharaAliasData(), PuppeteerUpdateType.FullDataUpdate));
        }
